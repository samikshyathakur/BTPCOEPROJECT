		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Coe Project",
									"targetURL": "#btpcoeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"btpcoeproject-display": {
								"semanticObject": "btpcoeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=btpcoeproject",
									"url": sap.ui.require.toUrl("btpcoeproject")
								}
							}
						}
					}
